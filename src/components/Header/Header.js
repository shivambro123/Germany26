...
const Header = () => {
  return (
    <Container>
      <div
        className="headerwrapper hidden md:flex py-2 px-4 items-center md:py-3"
        id="first"
      >
        <div className="contact flex flex-wrap">
          <div className="flex justify-start w-full md:justify-normal mb-2 md:mb-0">
            <div className="flex items-center justify-start md:justify-start my-2 md:my-0">
        ...
        <div className="social justify-end ">
          <div className="social_content flex justify-center md:justify-end ">
            <FaInstagram className="mx-2 text-3xl leading-0 hover:text-orange-400" />
            <FaFacebookF className="mx-2 text-3xl leading-0 hover:text-orange-400" />
            <FaLinkedin className="mx-2 text-3xl leading-0 hover:text-orange-400" />
            <LiaYoutube className="mx-2 text-3xl leading-0 hover:text-orange-400" />
          </div>
        </div>
      </div>
